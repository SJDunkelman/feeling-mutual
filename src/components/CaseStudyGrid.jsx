    ...
    return (
      <Link to="/">
        <div className="group mobile-only:flex mobile-only:flex-col px-4 mobile-only:mb-12 text-center lg:relative lg:py-2 w-full h-auto lg:w-60 lg:h-40">
          ...
          <div className="flex mobile-only:flex-col mobile-only:items-center mobile-only:space-y-4 lg:hidden lg:group-hover:block lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 w-full text-gold">
