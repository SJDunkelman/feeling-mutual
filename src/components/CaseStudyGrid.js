    ...
    return (
      ...
      {/*<Link to="/coming-soon" key={i}>*/}
        <div className="group mobile-only:flex mobile-only:flex-col px-4 mobile-only:mb-12 text-center sm:relative sm:py-2 w-full h-auto lg:w-80 bg-transparent">
          ...
          <div className="flex mobile-only:flex-col mobile-only:items-center mobile-only:space-y-4 md:hidden md:group-hover:block md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 w-full h-40 text-sandybrown">
